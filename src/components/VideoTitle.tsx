...
const VideoTitle = ({ content }: { content: videoContent }) => {
	...
	return (
		<div className="absolute aspect-video max-w-full bg-gradient-to-r from-black  font-bold text-white p-4 px-20  pt-70">
			<p className=" text-6xl my-10">{content?.[0]?.title}</p>
